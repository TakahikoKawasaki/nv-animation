...
public class CompositeInterpolator extends InterpolatorBase
{
     ...
     */
    private static final Interpolator DEFAULT_INTERPOLATOR = LINEAR_INTERPOLATOR;


    /**
     * Interpolators registered into this {@code CompositeInterpolator}.
     */
    ...
    protected final void doInterpolate(float[] from, float[] to, int count, float ratio, float[] output)
    {
        ...
        Arrays.fill(output, 0, count, 0.0F);

        // A work buffer to hold one interpolated value.
        float[] work = new float[count];
     ...
     *         interpolator was added to this {@code CompositeInterpolator}.
     *
     * @throws IllegalArgumentException
     *         {@code interpolator} is null.
     */
    ...
    /**
     * Get an immutable list of all pairs of interpolator and weight.
     *
     * @return
